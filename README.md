...
A modern reimplementation of the Trainable Segmentation plugin for Fiji, focused on improved speed, maintainability, and a clean architecture. The project aims to provide a faster and more extensible foundation for interactive machine-learning–based image segmentation using Python as a programing Language
